...
void set_parameter() {
  ...
  param.pgain_sonar_tz = 0;//45.0/1000.0;
  param.dgain_sonar_tz = 0;//20.0;
  ...
  param.pgain_degx = 0;//880;
  param.pgain_degy = 0;//880;
  param.pgain_degz = 0;//2400;
  param.dgain_degx = 0;//22;
  param.dgain_degy = 0;//22;
  param.dgain_degz = 0;//28;
